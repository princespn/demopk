...
trait SupportTicketManager
{
    ...
    {   
        ...
        $supports = SupportTicket::where($this->column, $user->id)->where('user_type', strtoupper($this->userType))->orderBy('id', 'desc')->paginate(getPaginate());
    ...
    {   
        ...
        $ticket->user_type  = strtoupper($this->userType);
