...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    public function showLinkRequestForm()
    {
        ...
        return view($this->activeTemplate . 'merchant.auth.passwords.email', compact('pageTitle'));
    }
    ...
    public function codeVerify(){
        ...
        return view($this->activeTemplate.'merchant.auth.passwords.code_verify',compact('pageTitle','email'));
    }
