...
class ReportController extends Controller{
    ...
    public function transaction(Request $request){
        ...
        $transactions = Transaction::with(['wallet','currency','receiverUser','receiverAgent','receiverMerchant'])->orderBy('id','desc');
        ...
        $transactions = $transactions->filter(['trx_type', 'remark', 'user_type', 'currency:currency_id'])->dateFilter()->paginate(getPaginate());
    ...
    public function loginHistory(Request $request){
        ...
        $loginLogs = UserLogin::where($response['column'], '!=', 0)->with($response['with']);
    ...
    public function loginIpHistory($ip){ 
        ...
        $loginLogs = UserLogin::where('user_ip',$ip)->orderBy('id','desc')->with('user', 'agent', 'merchant')->paginate(getPaginate());
    ...
    public function notificationHistory(Request $request){
        ...
        $logs = $logs->filter(['user_type'])->with(['user', 'agent', 'merchant'])->paginate(getPaginate());
