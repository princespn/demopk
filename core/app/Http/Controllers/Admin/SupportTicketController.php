...
class SupportTicketController extends Controller
{
    ...
    public function tickets()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->with(['user', 'agent', 'merchant'])->paginate(getPaginate());
    ...
    public function pendingTicket()
    {
        ...
        $items = SupportTicket::whereIn('status', [0,2])->orderBy('id','desc')->with(['user', 'agent', 'merchant'])->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::where('status',3)->orderBy('id','desc')->with(['user', 'agent', 'merchant'])->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->with(['user', 'agent', 'merchant'])->where('status',1)->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    } 

    public function ticketReply($id)
    {   
        $ticket = SupportTicket::with(['user', 'agent', 'merchant'])->where('id', $id)->firstOrFail();
