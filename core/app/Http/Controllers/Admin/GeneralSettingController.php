...
class GeneralSettingController extends Controller
{
    ...
    {       
        ...
        $general->detect_activity = $request->detect_activity ? 1 : 0;
        $general->enable_language = $request->enable_language ? 1 : 0;
        ...
        $general->otp_verification = $request->otp_verification ? 1 : 0;
