                ...
                <form action="{{ route('admin.currency.api.update') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" type="text" name="fiat_api_key" required value="{{$general->fiat_currency_api}}">
                            </div>
                            <div class="form-group mb-3">
                                <u><small class="fw-bold">@lang('Cron job for fiat price rate :')</small></u>
                                <small class="fiatCron">{{route('cron.fiat.rate')}}</small>
                                <i class="las la-copy btn ps-0 text--primary copyCronLink" title="@lang('Copy')" data-class="fiatCron"></i>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="justify-content-between d-flex flex-wrap">
                            ...
                            <div class="col-sm-12">
                                <input class="form-control" type="text" name="crypto_api_key" required value="{{$general->crypto_currency_api}}">
                            </div>
                            <div>
                                <u><small class="fw-bold">@lang('Cron job for crypto price rate') : </small> </u>
                                <small class="cryptoCron">{{route('cron.crypto.rate')}}</small>
                                <i class="las la-copy btn ps-0 text--primary copyCronLink" title="@lang('Copy')" data-class="cryptoCron"></i>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        ...
        (function($) {
            ...
            $('.editBtn').on('click', function() {
                ...
                modal.find('select[name=currency_type]').val(currency.currency_type)
