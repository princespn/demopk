                    ...
                    <table class="table table--light style--two">
                        ...
                        @forelse($deposits as $deposit)
                            ...
                            <tr>
                                ...
                                <td> 
                                    {{ showAmount($deposit->amount,$general->currency ) }} {{ __($deposit->method_currency) }} + <span class="text-danger" title="@lang('charge')">{{ showAmount($deposit->charge,$general->currency)}} </span>
                                    <br>
                                    <strong title="@lang('Amount with charge')">
                                    {{ showAmount($deposit->amount+$deposit->charge,$general->currency) }} {{ __($deposit->method_currency) }}
                                    </strong>
                                </td>
                                <td>
