...
<div class="row justify-content-center">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        <div class="">
                            <img src="{{ getImage(getFilePath('qr_code_template') . '/' . $general->qr_code_template, '2480x3508') }}" class="b-radius--10 w-100">
                        </div>
                    </div>
                </div>
            </div>
    ...
    @endif
    <div class="col-xl-{{ $general->qr_code_template ? 4 : 6 }} form-group">
        <div class="custom">
