                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('OTP Expiration')</label>
                                <div class="input-group">
                                    <input class="form-control" type="number" step="any" name="otp_expiration" required value="{{$general->otp_expiration}}" placeholder="@lang('Seconds')">
