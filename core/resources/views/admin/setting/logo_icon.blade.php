                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="profilePicPreview logoPicPrev" style="background-image: url({{ getImage(getFilePath('logoIcon').'/dark_logo.png', '?'.time()) }})">
                                                        <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="profilePicUpload" id="profilePicUpload2" accept=".png, .jpg, .jpeg" name="dark_logo">
                                            <label for="profilePicUpload2" class="bg--primary">@lang('Select Dark Logo')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload3" class="bg--primary">@lang('Select Favicon')</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
