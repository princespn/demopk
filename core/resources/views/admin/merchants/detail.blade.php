    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <a href="{{ route('admin.withdraw.log', ['user_type'=>'MERCHANT', 'search'=>$merchant->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <a href="{{ route('admin.report.transaction', ['user_type'=>'MERCHANT', 'search'=>$merchant->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-4 col-sm-12">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content"> 
                            <h3 class="text-white">{{ $general->cur_sym }}{{showAmount($totalGetPaid)}}</h3>
                            <p class="text-white">@lang('Total Get Paid')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction', ['user_type'=>'MERCHANT', 'search'=>$merchant->username, 'remark'=>'merchant_payment']) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{route('admin.report.login.history', ['user_type'=>'MERCHANT', 'search'=>$merchant->username])}}" class="btn btn--primary btn--shadow w-100 btn-lg">
                        <i class="las la-list-alt"></i>@lang('Logins')
                    </a>
                </div>

                <div class="flex-fill">
                    <a href="{{ route('admin.merchants.notification.log',$merchant->id) }}" class="btn btn--secondary btn--shadow w-100 btn-lg">
                        <i class="las la-bell"></i>@lang('Notifications')
                    </a>
                </div>

                <div class="flex-fill">
                    <a href="{{route('admin.merchants.login',$merchant->id)}}" target="_blank" class="btn btn--primary btn--gradi btn--shadow w-100 btn-lg">
                        <i class="las la-sign-in-alt"></i>@lang('Login as Merchant')
                    </a>
                </div>

                @if($merchant->kyc_data)
                <div class="flex-fill">
                    <a href="{{ route('admin.merchants.kyc.details', $merchant->id) }}" target="_blank" class="btn btn--dark btn--shadow w-100 btn-lg">
                ...
                <div class="flex-fill">
                    ...
                    <button type="button" class="btn btn--warning btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                        <i class="las la-ban"></i>@lang('Ban Merchant')
                    </button>
                    @else
                    <button type="button" class="btn btn--success btn--gradi btn--shadow w-100 btn-lg userStatus" data-bs-toggle="modal" data-bs-target="#userStatusModal">
                        <i class="las la-undo"></i>@lang('Unban Merchant')
                    </button>
                    @endif
                </div>
            </div>
            ...
            <div class="row mt-30 g-4">
                            ...
                            <ul class="list-group"> 
                                @forelse ($wallets as $wallet) 
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="font-weight-bold">{{showAmount($wallet->balance,$wallet->currency)}}  {{__($wallet->currency->currency_code)}}</span>
                                    </li>
                                @empty
                ...
                <div class="col-lg-7 col-xxl-8 col-md-7 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">@lang('Information of') {{$merchant->fullname}}</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input class="form-control" type="text" name="firstname" required value="{{$merchant->firstname}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="lastname" required value="{{$merchant->lastname}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group  col-xl-3 col-md-6 col-12">
                                        ...
                                        <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                               ...
                                               @if($merchant->sv) checked @endif>
        
                                    </div>
                                    <div class="form-group col-xl-3 col-md- col-12">
                                        <label>@lang('2FA Verification') </label>
                                        <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disable')" name="ts" @if($merchant->ts) checked @endif>
                                    </div>
                                    <div class="form-group col-xl-3 col-md- col-12">
                                        <label>@lang('KYC') </label>
                                        <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')" data-off="@lang('Unverified')" name="kv" @if($merchant->kv == 1) checked @endif>
                                    </div>
                                </div>
    ...
    <div id="addSubModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.merchants.add.sub.balance',$merchant->id)}}" method="POST">
                    @csrf
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        @if($merchant->status == 1)
                            <span>@lang('Ban Merchant')</span>
                        @else
                            <span>@lang('Unban Merchant')</span>
                        @endif
                    </h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                ...
                <form action="{{route('admin.merchants.status',$merchant->id)}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        @if($merchant->status == 1)
                        <h6 class="mb-2">@lang('If you ban this merchant he/she won\'t able to access his/her dashboard.')</h6>
                        <div class="form-group">
                        ...
                        <p>{{ $merchant->ban_reason }}</p>
                        <h4 class="text-center mt-3">@lang('Are you sure to unban this merchant?')</h4>
                        @endif
                    </div>
                    <div class="modal-footer">
                        @if($merchant->status == 1)
...
<script>
    ...
    "use strict"
        ...
        $('select[name=country]').val('{{@$merchant->country_code}}');
        let dialCode        = $('select[name=country] :selected').data('mobile_code');
        let mobileNumber    = `{{ $merchant->mobile }}`;
