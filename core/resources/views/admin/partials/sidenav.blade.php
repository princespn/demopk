    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.currency.all')}}">
                    <a href="{{route('admin.currency.all')}}" class="nav-link ">
                        <i class="menu-icon las la-coins"></i>
                        <span class="menu-title">@lang('Manage Currency')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.transaction.charges')}}">
                    <a href="{{route('admin.transaction.charges')}}" class="nav-link ">
                        <i class="menu-icon las la-hand-holding-usd"></i>
                        <span class="menu-title">@lang('Transaction Charges')</span> 
                    </a>
                </li>

                <li class="sidebar__menu-header">@lang('Profit Logs')</li>
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.profit*',3)}}">
                        <i class="menu-icon las la-file-invoice-dollar"></i>
                        <span class="menu-title">@lang('Profit Logs')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.profit*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.profit.all')}}">
                                <a href="{{route('admin.profit.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Logs')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.profit.only')}}">
                                <a href="{{route('admin.profit.only')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Only Profits')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.profit.commission')}}">
                                <a href="{{route('admin.profit.commission')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Only Commissions')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar__menu-header">@lang('Manage Users')</li>
                <li class="sidebar-menu-item sidebar-dropdown">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.agents*',3)}}">
                        ...
                        @if($bannedAgentsCount > 0 || $emailUnverifiedAgentsCount > 0 || $mobileUnverifiedAgentsCount > 0 || $kycUnverifiedAgentsCount > 0 || $kycPendingAgentsCount > 0)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.agents*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.agents.email.unverified')}}">
                                <a href="{{route('admin.agents.email.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>
                
                                    @if($emailUnverifiedAgentsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$emailUnverifiedAgentsCount}}</span>
                                    @endif
                                </a>
                            </li>
                
                            <li class="sidebar-menu-item {{menuActive('admin.agents.mobile.unverified')}}">
                                <a href="{{route('admin.agents.mobile.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Mobile Unverified')</span>
                                    @if($mobileUnverifiedAgentsCount)
                                        <span
                                            class="menu-badge pill bg--danger ms-auto">{{$mobileUnverifiedAgentsCount}}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.merchants*',3)}}">
                        ...
                        <span class="menu-title">@lang('Merchants')</span>
                
                        @if($bannedMerchantsCount > 0 || $emailUnverifiedMerchantsCount > 0 || $mobileUnverifiedMerchantsCount > 0 || $kycUnverifiedMerchantsCount > 0 || $kycPendingMerchantsCount > 0)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.merchants.banned')}} ">
                                <a href="{{route('admin.merchants.banned')}}" class="nav-link">
                                    ...
                                    @if($bannedMerchantsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$bannedMerchantsCount}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item  {{menuActive('admin.merchants.email.unverified')}}">
                                <a href="{{route('admin.merchants.email.unverified')}}" class="nav-link">
                                    ...
                                    @if($emailUnverifiedMerchantsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$emailUnverifiedMerchantsCount}}</span>
                                    @endif
                                </a>
                            </li>
                
                            <li class="sidebar-menu-item {{menuActive('admin.merchants.mobile.unverified')}}">
                                <a href="{{route('admin.merchants.mobile.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Mobile Unverified')</span>
                                    @if($mobileUnverifiedMerchantsCount)
                                        <span
                                            class="menu-badge pill bg--danger ms-auto">{{$mobileUnverifiedMerchantsCount}}</span>
                                    @endif
                                </a>
                            </li>
                
                            <li class="sidebar-menu-item {{menuActive('admin.merchants.kyc.unverified')}}">
                                <a href="{{route('admin.merchants.kyc.unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('KYC Unverified')</span>
                                    @if($kycUnverifiedMerchantsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$kycUnverifiedMerchantsCount}}</span>
                                    @endif
                                </a>
                            </li>
                
                            <li class="sidebar-menu-item {{menuActive('admin.merchants.kyc.pending')}}">
                                <a href="{{route('admin.merchants.kyc.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('KYC Pending')</span>
                                    @if($kycPendingMerchantsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$kycPendingMerchantsCount}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.merchants.notification.all')}}">
                                <a href="{{route('admin.merchants.notification.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Notification to All')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar__menu-header">@lang('Manage KYC')</li>
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.kyc.setting*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{route('admin.kyc.setting', 'user_kyc')}}">
                                <a href="{{route('admin.kyc.setting', 'user_kyc')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('User KYC')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{route('admin.kyc.setting', 'agent_kyc')}}">
                                <a href="{{route('admin.kyc.setting', 'agent_kyc')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Agent KYC')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{route('admin.kyc.setting', 'merchant_kyc')}}">
                                <a href="{{route('admin.kyc.setting', 'merchant_kyc')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Merchant KYC')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar__menu-header">@lang('Payment & Others')</li>
                <li class="sidebar-menu-item sidebar-dropdown">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.module.setting')}}">
                    <a href="{{route('admin.module.setting')}}" class="nav-link">
                        <i class="menu-icon las la-box"></i>
                        <span class="menu-title">@lang('Module Setting')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.setting.qr.code.template')}}">
                    <a href="{{route('admin.setting.qr.code.template')}}" class="nav-link">
                        <i class="menu-icon las la-qrcode"></i>
                        <span class="menu-title">@lang('QR Code Template')</span>
                    </a>
                </li>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.setting.notification.push')}} ">
                                <a href="{{route('admin.setting.notification.push')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Push Setting')</span>
                                </a>
                            </li>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                        <ul>
                            ...
                            @foreach(getPageSections(true) as $k => $secs)
                                @if($k == 'sleep' && !$general->detect_activity)
                                    @continue
                                @endif
                                @if($secs['builder'])
