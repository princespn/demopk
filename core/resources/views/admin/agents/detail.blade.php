            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <a href="{{ route('admin.deposit.list', ['user_type'=>'AGENT', 'search'=>$agent->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <a href="{{ route('admin.withdraw.log', ['user_type'=>'AGENT', 'search'=>$agent->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <a href="{{ route('admin.report.transaction', ['user_type'=>'AGENT', 'search'=>$agent->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content"> 
                            <h3 class="text-white">{{ $general->cur_sym }}{{showAmount($totalMoneyIn)}}</h3>
                            <p class="text-white">@lang('Total Money In')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction', ['user_type'=>'AGENT', 'search'=>$agent->username, 'remark'=>'money_in']) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
