    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <a href="{{ route('admin.deposit.list', ['user_type'=>'USER', 'search'=>$user->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <a href="{{ route('admin.withdraw.log', ['user_type'=>'USER', 'search'=>$user->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <a href="{{ route('admin.report.transaction', ['user_type'=>'USER', 'search'=>$user->username]) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                        ...
                        <div class="widget-two__content"> 
                            <h3 class="text-white">{{ $general->cur_sym }}{{showAmount($totalMoneyOut)}}</h3>
                            <p class="text-white">@lang('Total Money Out')</p>
                        </div>
                        <a href="{{ route('admin.report.transaction', ['user_type'=>'USER', 'search'=>$user->username, 'remark'=>'money_out']) }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{route('admin.report.login.history', ['user_type'=>'user', 'search'=>$user->username] )}}" class="btn btn--primary btn--shadow w-100 btn-lg">
                            ...
                            <ul class="list-group"> 
                                @forelse ($wallets as $wallet) 
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <span class="font-weight-bold">{{showAmount($wallet->balance,$wallet->currency)}}  </span>
                                    </li>
                                @empty
