                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            @forelse($transactions as $trx)
                                <tr> 
                                    <td>
                                        <span class="fw-bold">{{ @$trx->getUser->fullname }}</span>
                                        <br>
                                        <span class="small">
                                            <a href="{{ appendQuery('search',@$trx->getUser->username) }}"><span>@</span>{{ @$trx->getUser->username }}</a>
                                        </span>
                                    </td>
                                    <td>
                                        @php echo @$trx->showUserType; @endphp
                                    </td>
                                    ...
                                    <td class="budget">
                                        <span class="fw-bold @if($trx->trx_type == '+')text-success @else text-danger @endif">
                                            {{showAmount($trx->amount,$general->currency)}} {{$trx->currency->currency_code}}
                                        </span>
                                    </td>
                                    ...
                                    <td>{{ __($trx->details) }} {{$trx->receiver ? @$trx->receiver->username : ''}}</td>
                                </tr>
                            @empty
                                <tr>
