...
<div id="invoiceholder">
    <div id="invoice" class="effect2">
        ...
        <div id="invoice-top">
            <div class="logo"><img src="{{getImage(getFilePath('logoIcon') .'/logo.png')}}"
                    alt="image"></div>
            <div class="title">
        ...
        <div id="invoice-mid">
            ...
            <div id="project" style="text-align: right;">
                ...
                <h3>{{ showAmount($invoice->total_amount, $invoice->currency) }} {{ $invoice->currency->currency_code }}
                </h3>
                <span
                    class="{{ $invoice->pay_status == 1 ? 'paid' : 'unpaid' }}">{{ $invoice->pay_status == 1 ? 'PAID' : 'UNPAID' }}</span>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        @foreach ($invoice->items as $item)
                            <tr class="service">
                                ...
                                <td class="tableitem" style="text-align: right; padding-right:10px;">
                                    <p class="itemtext">
                                        {{ $invoice->currency->currency_symbol }}{{ showAmount($item->amount, $invoice->currency) }}
                        ...
                        <tr class="tabletitle">
                            ...
                            <td class="payment">
                                <h2>{{ $invoice->currency->currency_symbol }}{{ showAmount($invoice->total_amount, $invoice->currency) }}
