                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="0.3" data-wow-delay="0.1s">
                    <div class="blog-card">
                        <div class="blog-card__thumb rounded-3">
                            <img src="{{ getImage('assets/images/frontend/blog/' .@$element->data_values->image) }}" alt="@lang('image')">
                        </div>
                        ...
                        <div class="blog-card__content">
                            <h4 class="blog-title">
                                <a href="{{ route('blog.details', ['slug'=>slug(@$element->data_values->title), 'id'=>$element->id]) }}">
                            ...
                            <a 
                                href="{{ route('blog.details', ['slug'=>slug(@$element->data_values->title), 'id'=>$element->id]) }}" 
                                class="font-size--14px fw-bold text--base mt-2"
                            >
                                @lang('Read More')
                            </a>
                        </div>
