        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-xl-6 order-xl-1 order-2 mt-xl-0 mt-5">
                ...
                <ul class="award-list d-flex flex-wrap align-items-center mt-3">
                    @foreach ($elements as $element)
                        <li>
                            <img src="{{ getImage('assets/images/frontend/about/' .@$element->data_values->award_logo, '100x100') }}"
                                alt="image"
                            >
                        </li>
                    @endforeach
            ...
            <div class="col-xl-5 order-xl-2 order-1">
                <div class="about-thumb">
                    <img src="{{ getImage('assets/images/frontend/about/' .@$content->background_image, '992x692') }}"
