                    ...
                    <div class="row form-group ">
                        <div class="col-lg-12 file-upload">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" class="input-group-text border-0 btn--success addFile rounded ms-2">
            ...
            $('.addFile').on('click', function() {
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        ...
                        <button type="button" class="input-group-text border-0 btn--danger remove-btn rounded ms-2"><i class="las la-times"></i></button>
                    </div>
                `)
            });
