                            ...
                            <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}"
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-3 mt-lg-0 mt-md-4">
                                        ...
                                        <button type="submit"
                                            class="btn btn--base custom-success w-100">@lang('Reply')</button>
                                    </div>
                                </div>
                            </form>
                        @endif
            ...
            $('.addFile').on('click', function() {
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        ...
                        <button type="button" class="input-group-text btn--danger remove-btn rounded ms-2"><i class="las la-times"></i></button>
                    </div>
                `)
            });
