        ...
        <div class="add-moeny-card-middle">
          <ul class="add-money-details-list">
            <li>
              ...
              <div class="value"><span class="sym">{{$invoice->currency->currency_symbol}}</span> <span class="show-amount">{{showAmount($invoice->total_amount,$invoice->currency)}}</span></div>
            </li>
            <li>
          ...
          <div class="add-money-details-bottom">
            ...
            <div class="value"><span class="sym">{{$invoice->currency->currency_symbol}}</span> <span class="payable">{{showAmount($invoice->total_amount,$invoice->currency)}}</span> </div>
          </div>
        </div>
