      ...
      <div class="d-flex justify-content-center">
          <div class="verification-code-wrapper">
              <div class="verification-area">
                  ...
                  <form action="{{route('merchant.verify.mobile')}}" method="POST" class="submit-form">
                      @csrf
                      <p class="verification-text mt-3">
                        @lang('A 6 digit verification code sent to your mobile number') :  +{{ showMobileNumber(merchant()->mobile) }}
                      </p>
                      ...
                      <div class="mb-3">
                          <p>
                              @lang('If you don\'t get any code'), <a href="{{route('merchant.send.verify.code', 'phone')}}"> @lang('Try again')</a>
                          </p>
