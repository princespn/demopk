...
@section('content')
    <section class="account-section">
            ...
            <div class="left-inner w-100">
                <div class="text-center">
                    <a class="site-logo" href="{{ route('home') }}"><img
                            src="{{ getImage(getFilePath('logoIcon') . '/dark_logo.png') }}" alt="@lang('logo')"></a>
                ...
                <form class="account-form mt-3" method="POST" action="{{ route('merchant.password.email') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form--control" name="value" value="{{ old('value') }}"
                            autofocus="off" placeholder="@lang('Enter username or email address')" required>
                    </div>
        ...
        <div class="right bg_img"
            style="background-image: url('{{ getImage('assets/images/frontend/merchant_login/' . @$content->background_image, '1920x1280') }}');">
        </div>
    </section>
@endsection
