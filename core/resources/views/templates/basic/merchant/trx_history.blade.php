    ...
    <div class="col-12">
        <div class="card custom--card border-0">
            ...
            <div class="card-body p-0">
                <form class="transaction-top-form my-3 px-3" action="" method="GET">
                    <div class="custom-select-search-box">
                        <input type="text" name="search" class="form--control" placeholder="@lang('Search by transaction ID or Identifier')" required>
                ...
                <div class="row gy-3 gx-3 p-3">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="custom-select-box-two">
                            ...
                            <select onChange="window.location.href=this.value">
                                ...
                                <option value="{{queryBuild('operation','make_payment')}}" {{request('operation') == 'make_payment' ? 'selected':''}}>
                                    @lang('Payments')
                                </option>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="custom-select-box-two"> 
                            ...
                            <select onChange="window.location.href=this.value">
                                <option value="{{queryBuild('currency','')}}" {{request('currency') == '' ? 'selected':''}}>@lang('All Currency')</option>
            ...
            @if($histories->hasPages())
                <div class="card-footer bg-transparent pt-4 pb-3 justify-content-end d-flex">
