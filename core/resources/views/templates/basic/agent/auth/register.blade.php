...
<section class="account-section style--two">
    <div class="left">
      <div class="left-inner w-100"> 
        ...
        <form class="account-form mt-5" action="{{ route('agent.register') }}" method="POST">
            @csrf
                <div class="row">
        ...
        <p class="font-size--14px text-center">@lang('Have an account?') <a href="{{route('agent.login')}}">@lang('Login here').</a></p>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <a href="{{ route('agent.login') }}" class="btn btn--base btn-sm">@lang('Login')</a>
            </div>
      </div>
    </div>
</div>
