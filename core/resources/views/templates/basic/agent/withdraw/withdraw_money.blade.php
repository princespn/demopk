...
@section('content')
        ...
        <div class="col-xl-10">
            <div class="card style--two">
                <div class="card-header">
                    ...
                    <a href="{{ route('agent.withdraw.methods') }}" class="btn btn-outline--primary btn-sm float-end"> <i class="las la-plus"></i> @lang('Add Method')</a>
                </div>
    ...
    <div class="modal fade" id="withdraw" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form action="{{ route('agent.withdraw.money') }}" method="post" id="form">
                @csrf
