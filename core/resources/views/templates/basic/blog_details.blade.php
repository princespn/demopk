            ...
            <div class="row gy-5">
                <div class="col-lg-8">
                    ...
                    <div class="blog-details-thumb">
                        <img src="{{ getImage('assets/images/frontend/blog/' .$blog->data_values->image, '640x480') }}" alt="@lang('image')" class="rounded-3 w-100">
                    </div>
                            ...
                            @foreach ($recentBlogs as $recentBlog)
                                <li class="s-post d-flex flex-wrap">
                                    <div class="s-post__thumb">
                                        <img src="{{ getImage('assets/images/frontend/blog/' .$recentBlog->data_values->image, '640x480') }}" alt="@lang('image')">
                                    </div>
                                    <div class="s-post__content">
                                        <h6 class="s-post__title"> 
											<a href="{{ route('blog.details', ['slug'=>slug(@$recentBlog->data_values->title), 'id'=>$recentBlog->id]) }}">
