                        ...
                        <div class="doc-section" id="introduction-section">
                            <div class="doc-content">
                                <section id="introduction">
                                    ...
                                    <p class="mt-2">@lang('This section describes the') <strong>{{ __($general->site_name) }}</strong>
                                        @lang('payment gateway API.')
                                    </p>
                                    <hr>
                                    <p class="text-justify">
                                        <strong>{{ __($general->site_name) }}</strong> @lang('API is easy to implement in your business software. Our API is well formatted URLs, accepts cURL requests, returns JSON responses.')
                                    </p>
                                    <p class="text-justify">
                        ...
                        <div class="doc-section" id="currency">
                            <div class="doc-content">
                                <section id=""> 
                                    ...
                                    <p class="mt-2">@lang('This section describes the currencies supported by') <strong>{{ __($general->site_name) }}</strong></p>
                                    <hr> 
                                    <p> 
                        ...
                        <div class="doc-section" id="api-key">
                            <div class="doc-content">
                                <section id="">
                                    ...
                                    <hr>
                                    <p class="text-justify">@lang('Login to your') <strong>{{ __($general->site_name) }}</strong>
